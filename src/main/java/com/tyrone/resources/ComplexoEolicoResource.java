...
public class ComplexoEolicoResource {
	...
	public ResponseEntity<ComplexoEolico> findById(@PathVariable Integer id) {
		ComplexoEolico obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}
	
	@RequestMapping(method=RequestMethod.GET)
	public ResponseEntity<List<ComplexoEolico>> findAll() {
		List<ComplexoEolico> lista = service.findAll();
		return ResponseEntity.ok().body(lista);
	}
	
	@RequestMapping(method=RequestMethod.POST)
	public ResponseEntity<Void> insert(@RequestBody ComplexoEolico obj) {
	...
	public ResponseEntity<Void> update(@RequestBody ComplexoEolico obj, @PathVariable Integer id) {
		obj.setId(id);
